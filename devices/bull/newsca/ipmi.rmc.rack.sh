...
_sensor_string="Rack functional"
...
;;
0x0200)
	_sensor_status="FAIL warn"
;;
0x0300)
	_sensor_status="FAIL critical"
;;
0x0400) 
	_sensor_status="DOWN hyc"
;;
0x0800)
	_sensor_status="FAIL cpc alert"
;;
0x1000)
	_sensor_status="MARK psu"
;;
na)
	_sensor_status="DOWN power off"
;;
*)
