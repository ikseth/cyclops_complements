...
then
        ...
        _ifstatus=$( $_ipcmd link | awk -v _if="$_netdev" '$0 ~ _if":" { _st=gensub(/<(.*)>/,"\\1","g",$3) ;  split(_st,d,",")
 ; if ( d[1] == "LOOPBACK" ) { print d[2] } else { if ( d[3] == "SLAVE" || d[3] == "MASTER" ) { print d[4] } else { print d[3] }}}' ) 
